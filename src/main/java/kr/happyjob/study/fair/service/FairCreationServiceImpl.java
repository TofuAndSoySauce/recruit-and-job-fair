...
public class FairCreationServiceImpl implements FairCreationService {
	...
	public int fairUpdate(Map<String, Object> paramMap) throws Exception {
		...
		return fairCreationDao.fairUpdate(paramMap);
	}

	@Override
	public int fairDelete(Map<String, Object> paramMap) throws Exception {
		
		return fairCreationDao.fairDelete(paramMap);
	}
