...
<body>
	<form id="myForm" action="" method="">
					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="Location">
								...
								<span class="btn_nav bold">마이페이지</span> <span class="btn_nav bold">즐겨찾기</span> <a href="../system/notice.do" class="btn_set refresh">새로고침</a>
							</p>
							<p class="conTitle">
								<span class="btn_nav bold">즐겨찾기 </span>
							</p>

							<div class="queryParamArea">
								<div class="excludesNotAppliedCheckbox checkBoxParam"> 
									<p>지원한 공고 제외</p>
									<input type="checkbox" id="excludesApplied"  name="excludesApplied" value="false">
								</div>
								<div class="excludesExpiredCheckBox checkBoxParam">
									<p>마감일 지난 공고 제외</p>
									<input type="checkbox" id="excludesExpired" name="excludesExpired" value="false" >
								</div>
								<div class="keywordInput">
								<input placeholder="공고이름으로 검색하세요"
									type="text" id="keyword" name="keyword" />
									<a class="btnType blue" href="#" id="searchLikeListBtn"
		...
		<div id="adDetailModal" class="layerPop layerType2"
					...
					<table id="adDetailTable" class="row">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="inputTxt p100"
									name="user_phone" id="user_phone" readonly />
								</td>
							</tr>
							<tr>
								<th scope="row">설립일</th>
								<td colspan="2"><input type="text" class="inputTxt p100"
									name="user_birthday" id="user_birthday" readonly />
								</td>
							</tr>
							<tr>
								<th scope="row">기업규모</th>
								<td colspan="2"><select type="text" class="inputTxt p100"
									name="user_company_size" id="user_company_size" readonly></select>
								</td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
								<td colspan="2"><input type="text" class="inputTxt p100"
									name="user_email" id="user_email" readonly />
								</td>
							</tr>
							<tr>
								<th scope="row">업종 <span class="font_red">*</span></th>
								<td colspan="2"><select type="text" class="inputTxt p100"
									name="user_company_category" id="user_company_category"
									readonly></select></td>
							</tr>
							<tr>
								<th scope="row">주소<span class="font_red">*</span></th>
								<td colspan="2"><input type="text" class="inputTxt p100"
									name="user_address" id="user_address" readonly />
								</td>
							</tr>
							...
							<tr>
								<th scope="row">경력</th>
								<td colspan="2"><select name="ad_experience"
									id="ad_experience" readonly></select></td>
							</tr>
							<tr>
								<th scope="row">급여</th>
								<td colspan="2"><select name="ad_salary" id="ad_salary"></select>
								</td>
							</tr>
							<tr>
								<th scope="row">학력</th>
								<td colspan="2"><select name="ad_education"
									id="ad_education" readonly></select></td>
							</tr>
							<tr>
								<th scope="row">직책</th>
								<td colspan="2"><select name="ad_role" id="ad_role"
									readonly></select></td>
							</tr>
							<tr>
								<th scope="row">직무</th>
								<td colspan="2"><select name="ad_position" id="ad_position"
									readonly></select></td>
							</tr>
							<tr>
								<th scope="row">근무형태</th>
								<td colspan="2"><select name="ad_type" id="ad_type"
									readonly></select></td>
							</tr>
							<tr>
								<th scope="row">근무지역</th>
								<td colspan="2"><select name="ad_location" id="ad_location"
									readonly></select></td>
							</tr>
							<tr>
								<th scope="row">우대사항</th>
								<td colspan="2"><input type="text" class="inputTxt p100"
									name="ad_perference" id="ad_perference" readonly />
								</td>
							</tr>
							<tr>
								<th scope="row">마감기한</th>
								<td colspan="2"><input type="date" id="ad_date"
									name="ad_date" style="font-size: 1.5em" readonly />
								</td>
							</tr>
							<!-- 공고내용 -->
							<tr>
	...
	<script src="/js/like/like-list.js"></script>
