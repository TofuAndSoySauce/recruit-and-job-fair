...
<script type="text/javascript">
	...
	function searchResume(cpage) {
		...
		var listcallback = function(res) {
			...
			$("#currentpage").val(cpage);
		 	...
		 	if($("#searchCase").val() == 2 && $("#totcnt").val() == 0) alert("검색되는 이력서가 없습니다.");  
	...
	// 열람기업 초기화
	function initResumeHistory(resume_no) {
/* 		var param = {resume_no : resume_no}
...
/* 		
	...
	function resumeHistory(cpage) {
		...
		var listcallback = function(res) {
			...
			$(".resumeHistoryBox").show();
			
			if(countResumeList == 0) alert("선택한 이력서를 열람한 기업이 없습니다.");
			...
			<div id="container">
				<ul>
					...
					<li class="contents">
						...
						<!-- 이력서 열람 기업 -->
						<div class="divComGrpCodList resumeHistoryBox">
						...
						<div class="paging_area resumeHistoryBox" id="resumeHistoryPagination"></div>
